...
import { type Pagination, type Poll, PollStatus, fillPagination, getEndDateInterval, getRegistrationEndInterval, getStartDateInterval } from '@smartapps-poll/common'
...
export const PublicPollList: FunctionComponent<PublicPollListProps> = ({ open }) => {
